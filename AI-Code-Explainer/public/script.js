async function explainCode() {
    ...
    if (!code.trim()) {
        output.textContent = explaining === 'english' ? "Please enter some code to explain." : "కృపా మీరు వివరించడానికి కొన్ని కోడ్ నమోదు చేయండి.";
        return;
    }

    loading.style.display = 'flex';
    output.style.display = 'none';
    loadingText.textContent = explaining === 'english' ? "Explaining code..." : "కోడ్ వివరణ...";
    try {
        ...
        output.textContent = explaining === 'english' ? "An error occurred while explaining the code." : "కోడ్ వివరించేటప్పుడు ఒక లోపం సంభవించింది.";
    } finally {
...
function clearCode() {
    ...
    const output = document.getElementById('output');
    const defaultText = document.getElementById('explainLanguage').value === 'english' ? "Your code explanation will appear here." : "మీ కోడ్ వివరణ ఇక్కడ కనిపిస్తుంది.";
...
function copyExplanation() {
    ...
    if (text === 'Your code explanation will appear here.' || 
